...
namespace QuizGame {
	...
	public class Grade1EnglishEasy :  MonoBehaviour {
		...
		[Header("Questions")]
		public List<QuestionSO> questionsGrade1EnglishEasy;
		...
		private void PickQuestion() {
			...
			int pick = Random.Range(0, questionsGrade1EnglishEasy.Count);
			// Pick it from the list
			ActiveQuestion = questionsGrade1EnglishEasy[pick];

			// Remove it so it won't get picked again during this game.
			questionsGrade1EnglishEasy.RemoveAt(pick);
		...
		public void GameOver() {
			...
			GameOverPoints.text = "Score: " + score;
		...
		public void Next() {
			...
			if (questionsGrade1EnglishEasy.Count > 0 && questionsGrade1EnglishEasy.Count > 5) {
				PickQuestion ();
			} else {
				GameOver ();
			}
